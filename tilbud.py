...
def SearchResultDF(search, geocook, sgn_preferences, sgn_i18n):
    ...
    for link in links:
        ...
        dato = pd.to_datetime(text.split()[-1])
...
def main():
    ...
    for search in tilbud:
        ...
        df = SearchResultDF(search, geocook, sgn_preferences, sgn_i18n)
        writer(search, df)
